...
if exportVideo  
   v = VideoWriter('C:\Users\edwar\Documents\School\ROB542\actuatorDynamics\Assignment 2\Video.mp4', 'MPEG-4');
...
for t_plt = t(1):playbackRate*1.0/FPS:t(end)
    ...
    wallObj.resetFrame
    wallObj.globalMove(SE3([0, wall_pos + block_h, 0]));
    ...
    springObj.updateState(SE3([0, xa_pos, 0, 0, 0, pi/2]), wall_pos - xa_pos + block_h);
