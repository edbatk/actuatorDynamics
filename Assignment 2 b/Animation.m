function paddleAnimation(p,t,X,c,exportVideo,playbackRate)
% Paddle Animation 
% Input
...
for t_plt = t(1):playbackRate*1.0/FPS:t(end)
    ...
    massObj.resetFrame
    massObj.globalMove(SE3([0, xm_pos + p.l0, 0]));
    ...
    springObj.updateState(SE3([0, xa_pos, 0, 0, 0, pi/2]), p.l0 +  xm_pos - xa_pos);
